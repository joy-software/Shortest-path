...
public class AlgoA {
    ...
    public void callmeilleurDabord(ArrayList<Point> ensemble)
    {
        ...
        String nom = "outputs/resultat Algo A.joar";
        ...
        fich.println("\tNotons ici qu'on exécute l'algorithme meilleur d'abord\n"
                + "\tPour l'algorithme A la fonction d'evaluation f est égale à la fonction d'heuristique (f(n) = h(n))");
        fich.println();
        fich.println();
        /**
         * Etape 1:
        ...
        else
        {
            ...
            else
            {
                ...
                for(String auto : faible.getSuccesseur().keySet())
                {
                     ...
                     */
                    temp.setEvaluation(temp.getHeuristique());
    ...
    private void plusfaiblepoint() {
        ...
        int indexfaible = 0;
            ...
            for(Point auto : open)
            {
                //System.out.println("auto evaluation "+auto.getEvaluation());
